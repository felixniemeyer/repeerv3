// Clean adapter registry that imports from packages
import type { WebsiteAdapter, TrustScore, AgentDiscovery } from '@repeer/adapter-interface'
import { AdvancedEtherscanAdapter } from '@repeer/etherscan-adapter'
// TODO: Enable when CommonJS import issues are resolved
